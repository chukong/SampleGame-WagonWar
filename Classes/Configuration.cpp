...
void GameConfig::initAnimation()
{
    ...
    cnm_shoot->setDelayPerUnit(0.2f);
    for (int i=1; i<=10 ; i++) {
    ...
    tank_idle->setDelayPerUnit(0.2f);
    for (int i=1; i<=5 ; i++) {
    ...
    tank_move->setDelayPerUnit(0.2f);
    for (int i=1; i<=4 ; i++) {
    ...
    tank_shoot->setDelayPerUnit(0.2f);
    for (int i=1; i<=4 ; i++) {
    ...
    rock_idle->setDelayPerUnit(0.2f);
    for (int i=1; i<=5 ; i++) {
    ...
    rock_move->setDelayPerUnit(0.2f);
    for (int i=1; i<=8 ; i++) {
    ...
    rock_shoot->setDelayPerUnit(0.2f);
    for (int i=1; i<=10 ; i++) {
	...
	mechgun_hit->setDelayPerUnit(0.2f);
    for (int i=1; i<=5; ++i) {
    ...
    mech_idle->setDelayPerUnit(0.2f);
    for (int i=1; i<=5 ; i++) {
    ...
    mechgun_idle->setDelayPerUnit(0.2f);
    for (int i=1; i<=5 ; i++) {
    ...
    mech_move->setDelayPerUnit(0.2f);
    for (int i=1; i<=7 ; i++) {
    ...
    mechgun_move->setDelayPerUnit(0.2f);
    for (int i=1; i<=7 ; i++) {
    ...
    mech_shoot->setDelayPerUnit(0.2f);
    for (int i=1; i<=10 ; i++) {
    ...
    mechgun_shoot->setDelayPerUnit(0.2f);
    for (int i=1; i<=10 ; i++) {
