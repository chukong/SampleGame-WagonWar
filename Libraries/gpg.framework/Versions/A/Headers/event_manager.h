...
class GPG_EXPORT EventManager {
 public:
  ...
  struct FetchResponse {
    /**
     * Can be one of the values enumerated in {@link ResponseStatus}.
     * If the response is not <code>VALID</code> or <code>STALE</code>,
     * <code>FetchResponse</code> returns an empty data map.
     */
    ResponseStatus status;
   ...
   * <code>Fetch(DataSource data_source, const std::string &id,</code>
   ...
   * <code>Timeout timeout, const std::string &id)</code>,
   * with <code>data_source</code> specified as <code>CACHE_OR_NETWORK</code>,
   ...
   * this function call equivalent to calling
   * <code>FetchResponse FetchBlocking(DataSource data_source,</code>
   * <code>Timeout timeout, const std::string &id)</code>, with your specified
   * <code>data_source</code> value, and <code>timeout</code> specified as 10
   * years.
   */
   ...
   * equivalent to calling
   * <code>FetchResponse FetchBlocking(DataSource data_source,</code>
   * <code>Timeout timeout, const std::string &id)</code>, with
