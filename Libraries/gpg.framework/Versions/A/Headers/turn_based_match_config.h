...
class GPG_EXPORT TurnBasedMatchConfig {
 public:
   ...
   * (<code>PlayerIdsToInvite</code>, <code>MinimumPlayers</code>, etc.) on
   * the <code>TurnBasedMatchConfig</code> object to be usable.
   */
  bool Valid() const;
   ...
   * "attacker" or "defender". The bit mask of any pairing players must equal
   * zero for auto-match. Can only be called if {@link Valid} returns true.
   */
