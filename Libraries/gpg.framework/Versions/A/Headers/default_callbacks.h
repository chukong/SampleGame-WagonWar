...
/// UNDOCUMENTED
void DEFAULT_ON_EVENT_REVEALED(
    std::string const &event_id) GPG_EXPORT;
...
/**
 * This is the default value of Builder::SetOnQuestReceived.
 * By default, this function logs the id of the quest which was received.
 */
void DEFAULT_ON_QUEST_RECEIVED(Quest quest) GPG_EXPORT;

/**
 * This is the default value of Builder::SetOnQuestRemoved.
 * By default, this function logs the id of the quest which was removed.
 */
void DEFAULT_ON_QUEST_REMOVED(std::string const &quest_id) GPG_EXPORT;
